...
public class Menu {
    ...
    public void displayMenu() {
        ...
        while (isContinue) {
            ...
            System.out.println("6. Rapport de vaccination");
    ...
    public void getVacciationReport() {
        Scanner scanner = new Scanner(System.in);
        boolean isContinue = true;
        while (isContinue) {
            System.out.println("\n1. Creer un rapport");
            System.out.println("2. Envoyer le rapport");
        }
        int choice = scanner.nextInt();

        switch (choice) {
            case 1:
                reservation.createReport();
                break;
            case 2:
                reservation.notifyVisitors();
                break;
            default:
                System.out.println("La valeur entree est invalide");
        }
